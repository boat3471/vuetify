import Vue from 'vue';
import { ZDialog, ZCard, ZCardTitle, ZCardText, ZCardActions, ZDivider, ZSpacer, ZRow, ZCol, ZIcon, ZBtn } from '../../../components';
import "../../../../src/zui/components/ZModal/ZModal.scss";
export const ZModalSingle = Vue.extend({
  ...
  methods: {
    ...
    genBody() {
      ...
      const titleClose = this.$createElement(ZCol, {
        props: {
          cols: 'auto'
        }
      ...
      const title = this.title ? this.$createElement(ZCardTitle, {
        staticClass: 'px-3 py-1'
      }, [this.$createElement(ZRow, {}, [titleName, this.showClose ? titleClose : ''])]) : null;
      const contentIcon = this.icon ? this.$createElement(ZCol, {
      ...
      const contentText = this.html ? this.$createElement(ZCol, {
        domProps: {
          innerHTML: this.message
        }
      }, []) : this.$createElement(ZCol, {}, [this.message]);
      const content = this.$createElement(ZCardText, {
        staticClass: 'pt-5'
      ...
      const actions = this.$createElement(ZCardActions, {}, [this.$createElement(ZSpacer), this.showCancel ? cancelBtn : null, sureBtn]);
      return this.$createElement(ZCard, {}, [this.title ? title : null, this.title ? this.$createElement(ZDivider) : null, content, this.$createElement(ZDivider), actions]);
    },
