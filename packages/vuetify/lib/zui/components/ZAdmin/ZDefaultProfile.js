...
import { ZMenu, ZBtn, ZCard, ZList, ZListItem, ZListItemIcon, ZListItemContent, ZListItemTitle, ZIcon, ZAvatar } from '../../../components';
export const ZDefaultProfile = Vue.extend({
  ...
  methods: {
    ...
    genList() {
      ...
      const logoutIcon = this.$createElement(ZListItemIcon, {}, [this.$createElement(ZIcon, {}, ['mdi-logout'])]);
      const logoutContent = this.$createElement(ZListItemContent, {}, [this.$createElement(ZListItemTitle, {}, ['Logout'])]);
    ...
    genActivator(props) {
      const photo = getSlot(this, 'profile-photo') || this.$createElement(ZIcon, {
        props: {
          size: 22
        }
      }, ['mdi-account-circle']);
