...
import "../../../src/zui/styles/ZSelect/index.scss";
...
export const ZSelect = mixins(VSelect, Sizeable).extend({
  ...
  computed: {
    ...
    listData() {
      const data = VSelect.options.computed.listData.call(this); // @ts-ignore
    ...
    $_menuProps() {
      const data = VSelect.options.computed.$_menuProps.call(this); // @ts-ignore
  ...
  methods: {
    genProgress() {// VSelect.options.methods.genProgress.call(this);
    },
